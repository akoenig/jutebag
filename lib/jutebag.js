...
;(function () {
    ...
    jutebag.configuration.set("accessToken", "adsasd");
    jutebag.configuration.save();

    console.log(jutebag.configuration);
    ...
    modules.forEach(function (module) {
        ...
        if (!stats.isDirectory() && path.extname(module) === ".js" && __filename.indexOf(module) === -1) {
        	...
        	module = require('./' + module)(jutebag.configuration);

            jutebag.commands.push(module);
        }
    });

    // DOCME
    if (!jutebag.configuration.exists()) {
    	// TODO: EXECUTE THE ASSISTANT
